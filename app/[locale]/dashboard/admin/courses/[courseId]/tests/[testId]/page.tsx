...
export default async function LessonPage ({
    ...
    const { multipleChoiceQuestions, freeTextQuestions, singleSelectQuestions } =
        ...
        <div className="flex-1 p-8 overflow-y-auto w-full space-y-4">
            ...
            <Tabs defaultValue="examData" className="w-full">
                <TabsList>
                    ...
                    <TabsTrigger value="examSubmissions">Exam Submissions</TabsTrigger>
                </TabsList>
                            ...
                            <>
                                ...
                                {freeTextQuestions.length > 0 && (
                                    <div>
                                        ...
                                        <FreeTextQuestionRead questions={freeTextQuestions} />
                                    </div>
                                )}
                                <Separator className="my-4" />
