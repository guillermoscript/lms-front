...
export interface Order {
  id: Database['public']['Tables']['invoices']['Row']['id']
  // amount: number;
  currencies: Database['public']['Tables']['currencies']['Row']['code']
  status: Database['public']['Tables']['invoices']['Row']['status']
  created_at: Database['public']['Tables']['invoices']['Row']['created_at']
  paid_at: Database['public']['Tables']['invoices']['Row']['paid_at']
  due_date: Database['public']['Tables']['invoices']['Row']['due_date']
