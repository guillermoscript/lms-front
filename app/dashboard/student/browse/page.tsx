      ...
      {!activeSubscription ? (
        <Alert className="mb-8 border-amber-500/20 bg-amber-500/10">
          ...
          <AlertDescription className="text-amber-600/90 dark:text-amber-400/90">
            You need an active subscription to enroll in courses. Subscribe now to get unlimited access to all courses!
            <div className="mt-4">
              <Link href="/pricing">
        ...
        <Alert className="mb-8 border-primary/20 bg-primary/10">
          ...
          <AlertTitle className="font-semibold">Active Subscription</AlertTitle>
          <AlertDescription>
            You have access to all courses with your{' '}
            <Badge variant="secondary" className="mx-1">
              {(activeSubscription.plan as any)?.plan_name || 'Premium'}
            </Badge>
            plan. Click "Enroll Now" to start learning any course!
          </AlertDescription>
        </Alert>
      )}
