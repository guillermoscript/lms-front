    ...
    return (
        <>
            ...
            <div className="space-y-8 p-6 lg:p-8 bg-gray-100 dark:bg-gray-900 rounded-lg shadow-lg">
              ...
              Teacher: <b>{teacherData.data?.full_name || 'Unknown'}</b>
                    </p>
                </div>
                {examData.data?.exam_questions.map((question) => {
                    ...
                    return (
                        ...
                        >
                            <h2 className="text-2xl font-semibold mb-2">{question.question_text}</h2>
                                    ...
                                    <>
                                        <div className="flex flex-col gap-2">
                                            {question.question_options.map((option) => {
                                                ...
                                                const isChecked = userAnwsers.some((a) =>
                                                    a.answer_text.split(',').includes(option.option_id.toString())
                                                )
                            ...
                            Feedback:
                                    ...
                                    <p className="p-2 bg-gray-100 dark:bg-gray-800 rounded">
                                        {question.question_type === 'true_false'
                                            ? answer?.answer_text.split('-')[1] === 'true'
                                                ? 'True'
                                                : 'False'
                                            : answer?.answer_text}
                                    </p>
