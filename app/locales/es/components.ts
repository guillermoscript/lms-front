...
Si tienes dudas, intenta diciendo: "Could you give me a fake scenario to practice my speaking?"`,
    ...
    SaveCode: {
        ...
        failedToSaveCode: 'Error al guardar el código',
        codeSavedSuccessfully: 'Código guardado con éxito',
        save: 'Guardar',
        javascript: 'JavaScript',
    },
    DashboardPage: {
        welcomeTitle: '¡Bienvenido/a de nuevo!',
        overviewDescription: 'Aquí tienes una visión general de tu progreso de aprendizaje',
        browseCourses: 'Explorar Cursos',
        viewCalendar: 'Ver Calendario',
        totalProgress: 'Progreso Total',
        totalProgressDescription: '{completedLessons} de {totalLessons} lecciones completadas',
        activeCourses: 'Cursos Activos',
        activeCoursesDescription: '{enrollments} inscripciones',
        recentViews: 'Vistas Recientes',
        recentViewsDescription: 'En los últimos 7 días',
        messages: 'Mensajes',
        messagesDescription: 'Conversaciones activas',
        continueLearning: 'Continuar Aprendiendo',
        viewAllCourses: 'Ver todos los cursos',
        myCourses: 'Mis Cursos',
        myCoursesDescription: 'Todos tus cursos inscritos',
        learningActivity: 'Actividad de Aprendizaje',
        learningActivityDescription: 'Tu progreso reciente en todos los cursos',
    ...
    CourseCard: {
        progress: 'Progreso',
        lessonsProgress: '{completedLessons} de {totalLessons} lecciones',
        nextExam: 'Próximo examen el {date}',
        continueLearning: 'Continuar Aprendiendo'
    },
    RecentActivity: {
