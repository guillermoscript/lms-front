...
If you have doubts, try saying: "Could you give me a fake scenario to practice my speaking?"`,
    ...
    DashboardPage: {
        ...
        overviewDescription: "Here's an overview of your learning progress",
        browseCourses: 'Browse Courses',
        viewCalendar: 'View Calendar',
        totalProgress: 'Total Progress',
        totalProgressDescription: '{completedLessons} of {totalLessons} lessons completed',
        activeCourses: 'Active Courses',
        activeCoursesDescription: '{enrollments} enrollments',
        recentViews: 'Recent Views',
        recentViewsDescription: 'In the last 7 days',
        messages: 'Messages',
        messagesDescription: 'Active conversations',
        continueLearning: 'Continue Learning',
        viewAllCourses: 'View all courses',
        myCourses: 'My Courses',
        myCoursesDescription: 'All your enrolled courses',
        learningActivity: 'Learning Activity',
        learningActivityDescription: 'Your recent progress across all courses',
        overview: 'Overview',
        courses: 'Courses',
        activity: 'Activity',
    ...
    CourseCard: {
        progress: 'Progress',
        lessonsProgress: '{completedLessons} of {totalLessons} lessons',
        nextExam: 'Next exam on {date}',
        continueLearning: 'Continue Learning'
    },
    RecentActivity: {
