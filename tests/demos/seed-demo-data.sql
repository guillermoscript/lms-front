...
-- ---------------------------------------------------------------------------
-- enrollments = learning record (no billing columns — entitlements model)
INSERT INTO enrollments (enrollment_id, user_id, course_id, status, tenant_id)
OVERRIDING SYSTEM VALUE
VALUES
-- Default School students
(1003,'a1000000-0000-0000-0000-000000000011',1001,'active','00000000-0000-0000-0000-000000000001'),
(1004,'a1000000-0000-0000-0000-000000000011',1003,'active','00000000-0000-0000-0000-000000000001'),
(1005,'a1000000-0000-0000-0000-000000000012',1001,'active','00000000-0000-0000-0000-000000000001'),
(1006,'a1000000-0000-0000-0000-000000000012',1002,'active','00000000-0000-0000-0000-000000000001'),
(1007,'a1000000-0000-0000-0000-000000000013',1003,'active','00000000-0000-0000-0000-000000000001'),
(1008,'a1000000-0000-0000-0000-000000000013',1004,'active','00000000-0000-0000-0000-000000000001'),
(1009,'a1000000-0000-0000-0000-000000000014',1001,'active','00000000-0000-0000-0000-000000000001'),
(1010,'a1000000-0000-0000-0000-000000000014',1005,'active','00000000-0000-0000-0000-000000000001'),
(1011,'a1000000-0000-0000-0000-000000000015',1002,'active','00000000-0000-0000-0000-000000000001'),
(1012,'a1000000-0000-0000-0000-000000000015',1004,'active','00000000-0000-0000-0000-000000000001'),
(1013,'a1000000-0000-0000-0000-000000000016',1003,'active','00000000-0000-0000-0000-000000000001'),
-- Also enroll existing test student in new courses
(1014,'a1000000-0000-0000-0000-000000000001',1003,'active','00000000-0000-0000-0000-000000000001'),

-- Code Academy students
(2003,'a1000000-0000-0000-0000-000000000017',2001,'active','00000000-0000-0000-0000-000000000002'),
(2004,'a1000000-0000-0000-0000-000000000017',2003,'active','00000000-0000-0000-0000-000000000002'),
(2005,'a1000000-0000-0000-0000-000000000018',2001,'active','00000000-0000-0000-0000-000000000002'),
(2006,'a1000000-0000-0000-0000-000000000018',2002,'active','00000000-0000-0000-0000-000000000002'),
(2007,'a1000000-0000-0000-0000-000000000019',2003,'active','00000000-0000-0000-0000-000000000002'),
(2008,'a1000000-0000-0000-0000-000000000020',2001,'active','00000000-0000-0000-0000-000000000002'),
(2009,'a1000000-0000-0000-0000-000000000020',2004,'active','00000000-0000-0000-0000-000000000002'),
-- Also enroll Alice in new courses
(2010,'a1000000-0000-0000-0000-000000000004',2003,'active','00000000-0000-0000-0000-000000000002')
ON CONFLICT (enrollment_id) DO NOTHING;

-- entitlements = access grant (one per source). These demo students hold a
-- product entitlement for each enrolled course.
INSERT INTO entitlements (user_id, course_id, tenant_id, source_type, source_id, status)
VALUES
('a1000000-0000-0000-0000-000000000011',1001,'00000000-0000-0000-0000-000000000001','product',1001,'active'),
('a1000000-0000-0000-0000-000000000011',1003,'00000000-0000-0000-0000-000000000001','product',1003,'active'),
('a1000000-0000-0000-0000-000000000012',1001,'00000000-0000-0000-0000-000000000001','product',1001,'active'),
('a1000000-0000-0000-0000-000000000012',1002,'00000000-0000-0000-0000-000000000001','product',1002,'active'),
('a1000000-0000-0000-0000-000000000013',1003,'00000000-0000-0000-0000-000000000001','product',1003,'active'),
('a1000000-0000-0000-0000-000000000013',1004,'00000000-0000-0000-0000-000000000001','product',1004,'active'),
('a1000000-0000-0000-0000-000000000014',1001,'00000000-0000-0000-0000-000000000001','product',1001,'active'),
('a1000000-0000-0000-0000-000000000014',1005,'00000000-0000-0000-0000-000000000001','product',1002,'active'),
('a1000000-0000-0000-0000-000000000015',1002,'00000000-0000-0000-0000-000000000001','product',1002,'active'),
('a1000000-0000-0000-0000-000000000015',1004,'00000000-0000-0000-0000-000000000001','product',1004,'active'),
('a1000000-0000-0000-0000-000000000016',1003,'00000000-0000-0000-0000-000000000001','product',1003,'active'),
('a1000000-0000-0000-0000-000000000001',1003,'00000000-0000-0000-0000-000000000001','product',1003,'active'),
('a1000000-0000-0000-0000-000000000017',2001,'00000000-0000-0000-0000-000000000002','product',2001,'active'),
('a1000000-0000-0000-0000-000000000017',2003,'00000000-0000-0000-0000-000000000002','product',2003,'active'),
('a1000000-0000-0000-0000-000000000018',2001,'00000000-0000-0000-0000-000000000002','product',2001,'active'),
('a1000000-0000-0000-0000-000000000018',2002,'00000000-0000-0000-0000-000000000002','product',2001,'active'),
('a1000000-0000-0000-0000-000000000019',2003,'00000000-0000-0000-0000-000000000002','product',2003,'active'),
('a1000000-0000-0000-0000-000000000020',2001,'00000000-0000-0000-0000-000000000002','product',2001,'active'),
('a1000000-0000-0000-0000-000000000020',2004,'00000000-0000-0000-0000-000000000002','product',2003,'active'),
('a1000000-0000-0000-0000-000000000004',2003,'00000000-0000-0000-0000-000000000002','product',2003,'active')
