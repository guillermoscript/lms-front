-- Fix custom_access_token_hook permissions and ensure it works correctly
-- This migration addresses: Error running hook URI: pg-functions://postgres/public/custom_access_token_hook
