    ...
    <div className="">
      <div className="">
        ...
        <p className="ng-binding">
          ...
          establecido por la Ley de Protección de Datos Personales es la página centrodocentezowie, propiedad de Zowie –
          58H4+HV2, Lechería 6016, Anzoátegui.
        </p>
        ...
        <p>
          ...
          y prestar nuestros servicios de una manera más eficiente y personalizada. <br />
          <br />
        </p>
        <p className="ng-binding">
          ...
          el que sirven (por ejemplo, para que el usuario se mantenga identificado en los servicios de Zowie) o bien
        ...
        <p className="ng-binding">
          ...
          visitas a los servicios de Zowie para identificar de forma anónima al visitante. Los objetivos principales que
          se persiguen son:
        </p>
        <p>
        ...
        <p className="ng-binding">
          Importante: Salvo que el usuario decida registrarse en un servicio de Zowie, la cookie nunca irá asociada a
          ningún dato de carácter personal que pueda identificarle. Dichas cookies sólo serán utilizadas con propósitos
        ...
        <p className="ng-binding">
          ...
          servicios de Zowie. Entre otros, se almacena la duración o frecuencia de visualización de posiciones
          publicitarias, la interacción con las mismas, o los patrones de navegación y/o comportamientos del usuario ya
          que ayudan a conformar un perfil de interés publicitario. De este modo, permiten ofrecer publicidad afín a los
          intereses del usuario.
        </p>
        <h3>Cookies publicitarias de terceros</h3>
        <p className="ng-binding">
          Además de la publicidad gestionada por las webs de Zowie en sus servicios, las webs de Zowie ofrecen a sus
          anunciantes la opción de servir anuncios a través de terceros (“Ad-Servers”). De este modo, estos terceros
          pueden almacenar cookies enviadas desde los servicios de Zowie procedentes de los navegadores de los usuarios,
        ...
        <p className="ng-binding">
          ...
          de Zowie utilizan la plataforma Doubleclick (Google) para gestionar estos servicios. Para más información,
          acuda a
        </p>
        <p>
          ...
          y a<a href="http://www.google.es/policies/privacy/ads/">http://www.google.es/policies/privacy/ads/</a>.
        </p>
        ...
        <p>
          ...
          <a href="http://windows.microsoft.com/es-es/windows-vista/cookies-frequently-asked-question" />
        ...
        <p className="ng-binding">
          Las webs de Zowie pueden modificar esta Política de Cookies en función de exigencias legislativas,
          reglamentarias, o con la finalidad de adaptar dicha política a las instrucciones dictadas por la Agencia
          Española de Protección de Datos, por ello se aconseja a los usuarios que la visiten periódicamente.
        </p>
        <p>
