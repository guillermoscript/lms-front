        ...
        >
            ...
            <div className="flex items-center gap-1.5 md:gap-2 px-2 md:px-2.5 py-1 rounded-lg hover:bg-accent/50 transition-colors shrink-0">
                <div className="relative flex items-center justify-center">
                    <div className="h-6 w-6 md:h-7 md:w-7 rounded-md bg-brand-tint flex items-center justify-center">
                        <IconStar className="size-3.5 md:size-4 text-brand-text" />
                    </div>
            ...
            <div className="flex items-center gap-1.5 px-2 md:px-2.5 py-1 rounded-lg hover:bg-accent/50 transition-colors">
                <div className={cn(
                    ...
                    summary.streak.current > 0 ? "bg-brand-tint text-brand-text" : "bg-muted text-muted-foreground"
                )}>
            ...
            {/* Coins */}
            <div className="flex items-center gap-1.5 px-2 md:px-2.5 py-1 rounded-lg hover:bg-accent/50 transition-colors">
                <div className="p-1 rounded-md bg-brand-tint text-brand-text transition-colors">
